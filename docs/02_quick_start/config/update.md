...
若您使用 NekroAgent Windows 安装器安装，可跳转[安装器更新流程](/docs/02_quick_start/config/update.md#安装器更新流程)观看
...
若您使用 NekroAgent Windows 安装器安装，可跳转[安装器切换预览版流程](/docs/02_quick_start/config/update.md#安装器切换预览版流程)观看
...
若您通过安装器切换至预览版的同时，备份了正式版数据，可在`总览控制台`点击`恢复正式版`按钮后，根据提示操作，如下图所示
