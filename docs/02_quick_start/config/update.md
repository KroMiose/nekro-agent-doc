...
若您使用NekroAgent Windows安装器安装，可跳转[此处](/docs/02_quick_start/config/update.md#安装器更新流程)观看
...
若您使用NekroAgent Windows安装器安装，可跳转[此处](/docs/02_quick_start/config/update.md#安装器切换预览版流程)观看
